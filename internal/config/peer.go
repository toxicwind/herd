...
type PeerConfig struct {
	...
	// ApiKey injected as Authorization: Bearer <key>. Empty means keyless mode:
	// no auth is sent (the free text.pollinations.ai/openai route takes none).
	// The old dummy-Bearer test hack is gone -- do not resurrect it.
