...
require (
	...
	github.com/smart-mcp-proxy/mcpproxy-go v0.66.1
...
replace github.com/smart-mcp-proxy/mcpproxy-go => /home/toxic/go/pkg/mod/github.com/smart-mcp-proxy/mcpproxy-go@v0.65.0
